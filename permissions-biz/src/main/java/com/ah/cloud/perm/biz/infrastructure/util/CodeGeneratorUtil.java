...
class CodeGeneratorUtil {
    ...
    public static void main(String[] args) {
        ...
        //todo 需要生成的表
        String[] tables = new String[]{"perm_role"};
        ...
        String srcPath = projectPath + "/perm-biz/src/main/java";
        ...
        dsc.setUrl("jdbc:mysql://49.234.219.109:3306/perm-test?nullCatalogMeansCurrent=true&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8")
        ...
        pc.setParent("");
        pc.setEntity("com.ah.cloud.perm.biz.infrastructure.repository.bean")
                .setMapper("com.ah.cloud.perm.biz.infrastructure.repository.dao")
                .setService("com.ah.cloud.perm.biz.infrastructure.application.service")
                .setServiceImpl("com.ah.cloud.perm.biz.infrastructure.application.service.impl")
        ;
        Map<String, String> packageInfo = new HashMap<>();
        packageInfo.put(ConstVal.ENTITY, "com.ah.cloud.perm.biz.infrastructure.repository.bean");
        packageInfo.put(ConstVal.MAPPER, "com.ah.cloud.perm.biz.infrastructure.repository.dao");
        packageInfo.put(ConstVal.SERVICE, "com.ah.cloud.perm.biz.infrastructure.application.service");
        packageInfo.put(ConstVal.SERVICE_IMPL, "com.ah.cloud.perm.biz.infrastructure.application.service.impl")
        ;
