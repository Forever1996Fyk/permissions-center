...
@Slf4j
@Component
public class ValidateCodeAccessProvider extends AbstractAccessProvider {

    private final static String LOG_MARK = "ValidateCodeAccessProvider";
    ...
    public boolean support(Authentication authentication) {
        return ValidateCodeAuthenticationToken.class.isAssignableFrom(authentication.getClass());
    }
