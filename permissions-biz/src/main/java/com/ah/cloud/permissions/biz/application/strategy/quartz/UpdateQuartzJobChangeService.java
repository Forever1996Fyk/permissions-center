 ...
 **/
@Component
public class UpdateQuartzJobChangeService extends AbstractQuartzJobChangeService {

    @Override
    protected void doHandleChange(QuartzJob quartzJob) {
        schedulerManager.updateScheduleJob(quartzJobHelper.convertScheduleJob(quartzJob));
    }

    @Override
    public QuartzJobChangeTypeEnum getQuartzJobChangeTypeEnum() {
        return QuartzJobChangeTypeEnum.UPDATE;
    }
}
