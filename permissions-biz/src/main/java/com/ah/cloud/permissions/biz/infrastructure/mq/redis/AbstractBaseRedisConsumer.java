...
public abstract class AbstractBaseRedisConsumer<T> implements MessageListener, InitializingBean {
    ...
    public void onMessage(Message message, byte[] pattern) {
        ...
        try {
            ...
            log.info("{} handle message error, params is {}, reason is {} ", channel, JsonUtils.toJSONString(t), Throwables.getStackTraceAsString(throwable));
        }
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        redisMessageListenerContainer.addMessageListener(getMessageListener(), new ChannelTopic(getChannel()));
    }
