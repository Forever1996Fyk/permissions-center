...
public class CodeGeneratorUtil {
    ...
    public static void main(String[] args) {
        ...
        //todo 需要生成的表
        String[] tables = new String[]{"sys_import_template_info"};
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/permission-center?nullCatalogMeansCurrent=true&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8&useSSL=false")
