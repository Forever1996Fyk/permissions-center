 ...
 **/
@Component
public class EdiFailAlarmHandler extends AbstractEdiAlarmHandler {
    private final static String LOG_MARK = "EdiFailAlarmHandler";
    ...
    public EdiAlarmTypeEnum getEdiAlarmTypeEnum() {
        return EdiAlarmTypeEnum.EDI_ERROR;
    }
}
