 ...
 **/
@Component
public class EdiInitAlarmHandler extends AbstractEdiAlarmHandler {
    private final static String LOG_MARK = "EdiInitAlarmHandler";
    ...
    public EdiAlarmTypeEnum getEdiAlarmTypeEnum() {
        return EdiAlarmTypeEnum.EDI_RETRY_INIT;
    }
}
