 ...
 **/
@Component
public class EdiRetryingAlarmHandler extends AbstractEdiAlarmHandler {
    private final static String LOG_MARK = "EdiRetryingAlarmHandler";
    ...
    public EdiAlarmTypeEnum getEdiAlarmTypeEnum() {
        return EdiAlarmTypeEnum.EDI_RETRY_ING;
    }
}
