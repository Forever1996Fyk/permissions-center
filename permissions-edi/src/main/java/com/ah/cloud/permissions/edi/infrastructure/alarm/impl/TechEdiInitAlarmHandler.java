 ...
 **/
@Component
public class TechEdiInitAlarmHandler extends AbstractEdiAlarmHandler {
    private final static String LOG_MARK = "TechEdiInitAlarmHandler";
    ...
    public EdiAlarmTypeEnum getEdiAlarmTypeEnum() {
        return EdiAlarmTypeEnum.TECH_EDI_RETRY_INIT;
    }
}
