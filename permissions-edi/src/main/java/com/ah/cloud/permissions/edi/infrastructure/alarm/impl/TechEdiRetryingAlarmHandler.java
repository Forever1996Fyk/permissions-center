 ...
 **/
@Component
public class TechEdiRetryingAlarmHandler extends AbstractEdiAlarmHandler {
    private final static String LOG_MARK = "TechEdiRetryingAlarmHandler";
    ...
    public EdiAlarmTypeEnum getEdiAlarmTypeEnum() {
        return EdiAlarmTypeEnum.TECH_EDI_RETRY_ING;
    }
}
