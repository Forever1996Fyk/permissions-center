 ...
 **/
@Component
public class TechEdiRetryingResetAlarmHandler extends AbstractEdiAlarmHandler {
    private final static String LOG_MARK = "TechEdiRetryingResetAlarmHandler";
    ...
    public EdiAlarmTypeEnum getEdiAlarmTypeEnum() {
        return EdiAlarmTypeEnum.TECH_EDI_RETRY_ING_RESET;
    }
}
