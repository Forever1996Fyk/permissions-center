...
(
    ...
    sex           tinyint(1) unsigned default 1                 not null comment '性别(1: 男, 2: 女)',
    avatar        varchar(255)        default ''                not null comment '用于头像路径',
    status        tinyint(2) unsigned default 1                 not null comment '账号状态(1:正常,2:停用,3:注销)',
...
(
    ...
    menu_type     tinyint             default 1                 not null,
    ...
    open_type     tinyint(1) unsigned default 1                 not null comment '打开方式(1:页面内,2:外链)',
...
(
    ...
    api_type      tinyint(2) unsigned         default 0                not null comment '接口类型',
    api_desc      varchar(200)        default ''                not null comment '接口描述',
    api_url       varchar(100)        default ''                not null comment '请求路径',
    status        tinyint(2) unsigned default 1                 not null comment '账号状态(1:启用,2:停用)',
    is_auth       tinyint(1) unsigned default 1                 not null comment '是否认证',
    is_open       tinyint(1) unsigned default 1                 not null comment '是否公开',
    remark        varchar(200)        default ''                not null comment '备注',
    creator       varchar(64)                                   not null comment '行记录创建者',
    modifier      varchar(64)                                   not null comment '行记录最近更新人',
    created_time  timestamp           default CURRENT_TIMESTAMP not null comment '行记录创建时间',
